...
export default function DoctorDashboard() {
  ...
  useEffect(() => {
    ...
    // Fetch doctor data from session API with the token
    const fetchDoctorData = async () => {
      try {
        ...
        // Store doctor data in localStorage for the header component
        ...
        // Redirect to login page after 2 seconds if we can't get the doctor data
        setTimeout(() => {
          router.push("/doctor");
        }, 2000);
      } finally {
